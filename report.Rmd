...
Using importance sampling: $P_{IS}(Adverse Event) = \frac1N \sum_{i=1}^{N}\frac{f_X(x_i)f_B(b_i)}{g_X(x_i)g_B(b_i))}logit^{-1}(f(x_i, b_i))$, where $X$ ~ Gamma(2.4, 2) and $g_B(b_i)$ ~ Log-Normal(-1, 0.6). 
