...
In this project, our objective is to design a simulation study that estimates the population-level probability 
of adverse events 

We are interested in estimating the overall (population-level) probability of
an adverse event, marginalizing over both X (across all patients) and the random effect distribution b
(across all clinics)
