...
subtitle: "P8160 - Group Project"
author: "Group 3A: Kate Colvin (kac2301), Xuanyu Guo(xg2451), Dang Lin (dl3757), and Boxiang Tang (bt2654)"
date: "2025-03-03"
output: pdf_document
---
...
$P_{CV}(Adverse Event) = \frac1N \sum_{i=1}^{N}(logit^{-1}(x_i, b_i) - \beta(g(x_i, b_i)) - \mu_g)$
...
## 1
- Let b follows a Log-normal distribution with parameters meanlog = -1 and sdlog = 0.5.
- Let x follows a Gamma distribution with parameters shape = 2 and rate = 2.
...
b_samples_N <- rlnorm(N, meanlog = -1, sdlog = 0.5)  
x_samples_N <- rgamma(N, shape = 2, rate = 2)
